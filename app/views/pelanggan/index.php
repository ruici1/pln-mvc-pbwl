            ...
            <tbody>
                ...
                foreach ($data['rows'] as $row) { ?>
                        <tr>
                            ...
                            <td><a href="<?php echo URL; ?>/pelanggan/delete/<?php echo $row['pel_id']; ?>" class="btndlt" onclick="return confirm('Apakah Kamu Yakin Mau Menghapus Aku Dari Kehidupanmu?')">Delete</a></td>
                        </tr>
                <?php $no++;
                } ?>
            </tbody>
